...
#Reserved General-Register numbs
IM = 5
IS = 6
SP = 7
...
class CPU:
    ...
    def __init__(self):
        ...
        self.reg[SP] = 0xf4 #Register[7] set to 0xF4
        ...
        self.FL = 0 #Flag
        self.IE = 1 #Interrupts on or off
        self.SP = 7
    ...
    def alu(self, op, reg_a, reg_b):
        ...
        if op == "ADD":
            ...
            self.FL &= 0x11111000 #Clear out CMP flags
    ...
    def JEQ(self, opp_a, opp_b):
        print(f"CALLING ------------ JEQ(self: {self}, opp_a: {opp_a}, opp_b: {opp_b}")
        if self.FL & FL_EQ:
    ...
    def ADD(self, opp_a, opp_b):
        print(f"CALLING ------------ ADD(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("ADD", opp_a, opp_b)
        return(3, True)

    def SUB(self, opp_a, opp_b):
        print(f"CALLING ------------ SUB(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("SUB", opp_a, opp_b)
        return(3, True)
    
    def MUL(self, opp_a, opp_b):
        print(f"CALLING ------------ MUL(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("MUL", opp_a, opp_b)
        return(3, True)
        
    def DIV(self, opp_a, opp_b):
        print(f"CALLING ------------ DIV(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("DIV", opp_a, opp_b)
        return(3, True)

    def MOD(self, opp_a, opp_b):
        print(f"CALLING ------------ MOD(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
    ...
    def INC(self, opp_a, opp_b):
        print(f"CALLING ------------ INC(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("INC", opp_a, opp_b)
        return(3, True)
        
    def DEC(self, opp_a, opp_b):
        print(f"CALLING ------------ DEC(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
    ...
    def CMP(self, opp_a, opp_b):
        print(f"CALLING ------------ CMP(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
    ...
    def AND(self, opp_a, opp_b):
        print(f"CALLING ------------ AND(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("AND", opp_a, opp_b)
        return(3, True)

    def NOT(self, opp_a, opp_b):
        print(f"CALLING ------------ NOT(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("NOT", opp_a, opp_b)
        return(2, True)


    def OR(self, opp_a, opp_b):
        print(f"CALLING ------------ OR(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("OR", opp_a, opp_b)
        return(3, True)


    def XOR(self, opp_a, opp_b):
        print(f"CALLING ------------ XOR(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("XOR", opp_a, opp_b)
        return(3, True)


    def SHL(self, opp_a, opp_b):
        print(f"CALLING ------------ SHL(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.alu("SHL", opp_a, opp_b)
        return(3, True)

    def SHR(self, opp_a, opp_b):
        print(f"CALLING ------------ SHR(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
    ...
    def PUSH(self, opp_a, opp_b):
        print(f"CALLING ------------ PUSH(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
        self.SP -=1
    ...
    def POP(self, opp_a, opp_b):
        print(f"CALLING ------------ POP(self: {self}, opp_a: {opp_a}, opp_b: {opp_b})")
